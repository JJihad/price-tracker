...
ac_black_flag = Item(url='https://store.playstation.com/fr-ca/product/UP0001-CUSA00010_00-AC4GAMEPS4000001', label='ac_black_flag')
...
tom_clancy_breakpoint = Item(url='https://store.playstation.com/en-ca/product/UP0001-CUSA14405_00-GRW2SCEANORMAL00', label='tom_clancy_breakpoint')
